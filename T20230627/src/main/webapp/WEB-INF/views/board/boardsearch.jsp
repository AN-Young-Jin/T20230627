...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
	<h3>상세화면</h3>
	  ...
	  <table border="1" class="table">
		...
		<tr>
			<th>내용</th>
			<td colspan="3"><textarea name="content" cols="80" rows="5">${board.brdContent }</textarea></td>
		</tr>
	 	<tr>
			<th>작성시간</th>
						...
						<!-- <li class="left clearfix">
							<div>
								<div class="header">
									...
									<small class="pull-right text-muted">2023-06-05 15:43</small>
								</div>
								<p>Pig Hong!!</p>
							</div>
						</li> -->
	...
	// 			</li>
		...
		document.querySelector('#modalModBtn').addEventListener('click',function(e){
			...
			.then(result => {
				...
				tagetLI.querySelector('p').innerText = result.reply;
